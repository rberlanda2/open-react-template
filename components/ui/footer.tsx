        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">Você sabia que o xadrez é um jogo milenar, com registros de sua prática desde o século VI? Descubra os segredos estratégicos desse fascinante jogo com a orientação de Mestre Bolívar.</div>
            </div>
